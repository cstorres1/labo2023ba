...
# me salteo los meses duros de pandemia, 202005, 202006, 202007
# entreno en 18 meses

PARAM$future <- c(202109)
PARAM$final_train <- c(
  202107, 202106, 202105, 202104, 202103, 202102,
  202101, 202012, 202011, 202010, 202009, 202008, 202004, 202003, 202002, 202001, 201912,
  201911
)

PARAM$train$training <- c(
  202105, 202104, 202103, 202102, 202101,
  202012, 202011, 202010, 202009, 202008, 202004, 202003, 202002, 202001, 201912, 201911,
  201910, 201909
)
...
PARAM$train$semilla <- 694061 # cambiar por su propia semilla  !!!
