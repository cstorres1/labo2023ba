...
PARAM <- list()
PARAM$experimento <- "F1_ZZ6610"
PARAM$exp_input <- "F1_HT6510"
...
PARAM$semillas <- c(694061, 773831, 338959, 404779, 549533, 998749, 773027, 187843,
807571, 532061, 968827, 354149, 681427, 408943, 157427, 104311, 103903, 102871, 104287, 103319)
